  ...
  return (
    <div className="bg-gray-200 min-h-screen">
      <div className="relative pt-24 sm:pt-32 lg:pt-40 w-full max-w-[764px] mx-auto text-center bg-white px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 w-full text-sm sm:text-base md:text-lg text-gray-700 font-normal text-start">
          <ul className="list-inside space-y-6 sm:space-y-8 lg:space-y-10">
            <li>
            ...
            <li>
              ...
              <ul className="list-disc list-inside mt-2">
                <li>
                  청소년 보호법에 따라, 보호자 미 동반 시 미성년자(만 19세
                  미만)의 입실이 불가합니다.
                </li>
            ...
            <li>
              <strong>[체크아웃 안내]</strong>
              <ul className="list-disc list-inside mt-2 ">
                <li>
                  체크아웃 시간은 11:00까지입니다. 이를 초과할 경우, 추가
                  1시간마다 10,000원의 요금이 부과됩니다.
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul className="list-disc list-inside mt-2">
                ...
                <li>
                  고성방가 및 음주로 인해 다른 손님의 휴식에 방해가 될 경우,
                  강제 퇴실 조치가 취해지며 숙박료 환불은 불가능합니다.
                </li>
                ...
                <li>입실 시간 전 짐 보관 가능 여부는 사전에 문의해 주세요.</li>
              </ul>
            </li>
          </ul>
        </div>
        <div className="mt-12 w-full border-t border-t-[#DADADA] pt-6 flex justify-center space-x-4 sm:space-x-8 text-gray-700 pb-16">
          <button className="text-lg sm:text-xl md:text-2xl flex items-center hover:text-gray-500 focus:outline-none">
