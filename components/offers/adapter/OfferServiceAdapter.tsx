    ...
    >
      <div className="mx-auto grid gap-4 lg:gap-10 grid-cols-2">
        {serviceList.map((item, index) => (
          ...
          >
            <FaCheck />
            <span className="ml-2 block antialiased tracking-normal font-sans text-base font-medium text-gray-500 leading-snug normal-case transition-colors hover:text-gray-700">
              {item.title}
            </span>
          </div>
        ))}
